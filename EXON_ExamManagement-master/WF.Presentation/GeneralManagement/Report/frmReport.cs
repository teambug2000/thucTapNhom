...
namespace GeneralManagement.Supervisors
{
    public partial class frmReport : Form
    {
        ...
        {
            GetInfoShift();
            this.pR_REPORTCONTESTANTTableAdapter.Connection.ConnectionString = CL.Persistance.Common.GetConnectString("MTA_QUIZ_1");

            this.pR_REPORTCONTESTANTTableAdapter.Fill(this.mTA_QUIZ_8DataSet.PR_REPORTCONTESTANT, divisionShiftID, SupervisorID);
            this.sTAFFSTableAdapter.Connection.ConnectionString = CL.Persistance.Common.GetConnectString("MTA_QUIZ_1");
            this.sHIFTSTableAdapter.Connection.ConnectionString = CL.Persistance.Common.GetConnectString("MTA_QUIZ_1");
            this.rOOMTESTSTableAdapter.Connection.ConnectionString = CL.Persistance.Common.GetConnectString("MTA_QUIZ_1");
            this.contestantNotCompleteApdapter.Connection.ConnectionString = CL.Persistance.Common.GetConnectString("MTA_QUIZ_1");
