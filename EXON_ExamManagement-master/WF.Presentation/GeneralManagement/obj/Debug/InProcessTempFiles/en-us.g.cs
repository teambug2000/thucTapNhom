...
namespace GeneralManagement.Language {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class en_us : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(en_us).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(en_us));
        ...
        private string FindResource() {
            string[] resources = typeof(en_us).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".en-us.g.xaml") || resource.Equals("en-us.g.xaml"))) {
                    return resource;
                }
            }
