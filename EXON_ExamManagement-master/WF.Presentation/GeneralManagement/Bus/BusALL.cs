...
namespace GeneralManagement.Bus
{
    public class BusALL
    {
        ...
        private ISupervisorService supervisorService = new SupervisorService();
        ...
        internal SHIFT GetShiftByDivsionShiftID(int divisionShiftID)
        {
            return supervisorService.GetShiftByDivsionShiftID(divisionShiftID);
        }
        ...
        public bool AddTestNumberIndex(TESTNUMBER tn)
        {
            return supervisorService.AddTestNumberIndex(tn);
        }
        ...
        private List<int> ListContestantShiftIDInTestExist(int divisionShiftID)
        {
