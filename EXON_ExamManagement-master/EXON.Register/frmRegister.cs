    ...
    public partial class frmRegister : Form
    {
        ...
        private void AddNewRegister()
        {
            try
            {
                ...
                register.CurrentAddress = txtCurrentAddress.Text;
                register.ContestID = contestID;
                register.Status = 1;
                register.RegisteredDate = DateTimeHelpers.ConvertDateTimeToUnix(SystemTimeService.Now);
                register.Image = img;
                //register.CurrentAddress = FormatProperCase(txtCurrentAddress.Text) + " - " + FormatProperCase(txtHuyen.Text) + " - " + FormatProperCase(cboTinh.Text); ;
                List<REGISTERS_SUBJECTS> list = new List<REGISTERS_SUBJECTS>();
