...
namespace EXON.RegisterManager.Module.Controls
{
    public partial class ucQuanLiDangKi : BaseModule
    {
        ...
        private List<REGISTERDGV> lstRegisterDGV;
        ...
        private CONTESTANT IsContestant(int regID)
        {
            CONTESTANT con;
        ...
        private int Registered(int registerid)
        {
        ...
        private void UpdateInfoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Forms.frmRegister frm = new Forms.frmRegister(registerID, contestantID);
            frm.ShowDialog();
            Refresh();
        }
        ...
        private void GetfingerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                string s = ex.Message;
                MessageBox.Show("Không mở được thiết bị quét.");
            }
        }
