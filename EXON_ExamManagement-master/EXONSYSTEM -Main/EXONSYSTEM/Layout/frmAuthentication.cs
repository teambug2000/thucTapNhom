...
namespace EXONSYSTEM.Layout
{
    public partial class frmAuthentication : MetroForm
    {
        ...
        private UserHelper.ClientSide ClientSocket;
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (rEC.ErrorCode == Constant.STATUS_OK)
                {
                    ...
                    else if (rCI.Status == Constant.STATUS_DOING_BUT_INTERRUPT || rCI.Status == Constant.STATUS_DOING || rCI.Status == Constant.STATUS_LOGGED_DO_NOT_FINISH)
                    {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            DialogResult dResult = MetroMessageBox.Show(this, "Bạn đã hết thời gian để làm bài", Properties.Resources.MSG_MESS_0001, MessageBoxButtons.OK, MessageBoxIcon.Error, 100);
                            this.Close();
                        }
                        else
                        {
