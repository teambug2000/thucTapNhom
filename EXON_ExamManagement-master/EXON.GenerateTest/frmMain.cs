...
namespace EXON.GenerateTest
{
    public partial class frmMain : MetroForm
    {
        ...
        public frmMain(int ConstestID, int type, int currentStaffId, string Sql)
        {
            InitializeComponent();
            InitializeService();
            ...
            BaseControl.CurrentStaffId = currentStaffId;
            sql = new SqlConnection(Sql);
            sql.Open();
        }
...
#if DEBUG
            string _settingsFilePath = Path.Combine(Application.StartupPath, "settings.xml");
        ...
        private void RibbonButtonsInitialize()
        {
            ...
            InitBarButtonItem(rbiCreateAllTest, TagResource.CreateAllTest, Properties.Resources.CreateAllTest);
            InitBarButtonItem(rbiDeleteTest, TagResource.DeleteTest, Properties.Resources.DeleteTest);
            InitBarButtonItem(rbiDeleteAllTest, TagResource.DeleteAllTest, Properties.Resources.DeleteAllTest);
            ...
            InitBarButtonItem(rbiCreatePart, TagResource.CreatePart, Properties.Resources.CreatePart);
            ...
            InitBarButtonItem(bbiExportDoc, TagResource.ExportTestToDoc, Properties.Resources.ExportTestToDoc);
        }
        ...
        private void bbi_ItemClick(object sender, EventArgs e)
        {
            try
            {
                Log.Instance.WriteLog(LogType.INFO, (sender as RibbonButton).ToolTip + " click!");
        ...
        private void cbRandomQuestion_CheckBoxCheckChanged(object sender, EventArgs e)
        {
            XMLSettings.WriteValue("RandomQuestion", cbRandomQuestion.Checked.ToString());
            XMLSettings.ReadSettings();
        }
        ...
        private void cbGenerateFromOriginalTest_CheckBoxCheckChanged(object sender, EventArgs e)
        {
            cbGenerateFromBank.Checked = !cbGenerateFromOriginalTest.Checked;
            XMLSettings.WriteValue("GenerateFromOrignalTest", cbGenerateFromOriginalTest.Checked.ToString());
            XMLSettings.WriteValue("GenerateFromBank", cbGenerateFromBank.Checked.ToString());
            XMLSettings.ReadSettings();
        }

        private void cbGenerateFromBank_CheckBoxCheckChanged(object sender, EventArgs e)
        {
            cbGenerateFromOriginalTest.Checked = !cbGenerateFromBank.Checked;
            XMLSettings.WriteValue("GenerateFromBank", cbGenerateFromBank.Checked.ToString());
            XMLSettings.WriteValue("GenerateFromOrignalTest", cbGenerateFromOriginalTest.Checked.ToString());
            XMLSettings.ReadSettings();
        }
