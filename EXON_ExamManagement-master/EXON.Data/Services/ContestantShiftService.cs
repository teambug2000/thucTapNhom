...
namespace EXON.Data.Services
{
    public interface IContestantShiftService
    {
        ...
        void DeleteByContestant(int contestantId);
    ...
    public class ContestantShiftService : IContestantShiftService
    {
        ...
        public void DeleteByContestant(int contestantId)
        {
           
                IEnumerable<CONTESTANTS_SHIFTS> lstconshift = _ContestantShiftRepository.GetMulti(x => x.ContestantID == contestantId);
                foreach (var item in lstconshift)
                {
                    _ContestantShiftRepository.Delete(item.ContestantShiftID);
                }
