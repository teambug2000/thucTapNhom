...
namespace EXON.Data.Services
{
    public interface IContestantSubjectService
    {
        ...
        IEnumerable<CONTESTANTS_SUBJECTS> GetByContestantestID(int id);
    ...
    public class ContestantSubjectService : IContestantSubjectService
    {
        ...
        public IEnumerable<CONTESTANTS_SUBJECTS> GetByContestantestID(int id)
        {
            return _IContestantSubjectRepository.GetMulti(x => x.ContestantID == id);
        }
