...
namespace EXON.GetFinger
{
    public partial class frmGetFingerPrinter : Form
    {
        ...
        private int contestantID = 125;
        private IContestantService contestantsv;
        private IFingerPrinterService fingersv;
        ...
        private string ByteArr2String(byte[] b)
        {
                        ...
                        if (IsRegister)
                        {
                            ...
                            if (zkfp.ZKFP_ERR_OK == ret)
                            {
                                ...
                                if (finger != null)
                                {
                                    ...
                                    #endregion phát âm thanh khi có kết quả sai
                            ...
                            #endregion phát âm thanh khi quét đc vân tay
                            ...
                            if (RegisterCount >= REGISTER_FINGER_COUNT)
                            {
                                ...
                                if (zkfp.ZKFP_ERR_OK == (ret = zkfp2.DBMerge(mDBHandle, RegTmps[0], RegTmps[1], RegTmps[2], RegTmp, ref cbRegTmp)))
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        #endregion phát âm thanh khi lấy vân tay thành công
