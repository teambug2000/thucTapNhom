...
namespace EXON.MONITOR.Common
{
   ...
   public enum StatusDivisionShift{ Status_Zero,STATUS_INIT,STATUS_ARR, STATUS_ATTENDANCE , STATUS_VERITY, STATUS_DECRYPT, STATUS_DIVISIONTEST, STATUS_STARTTEST }
    }
}
